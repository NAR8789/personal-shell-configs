...
alias exa='lessless exa --classify --color=always'
alias cat='lessless cat'
alias e=exa
...
alias egrep='lessless egrep --color'
alias fgrep='lessless fgrep --color'
alias pgrep='lessless pgrep --color'
alias jq='lessless jq --color-output'
